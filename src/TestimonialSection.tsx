    ...
    return (
        <section className="testimonial-section">
            ...
            <div className="all-testimonial-cards">
                <TestimonialCards rating={5} imagePath={person1} name="Jane Doe" review="Delicious and fresh." />
                <TestimonialCards rating={5} imagePath={person2} name="Some Person" review="Delicious and fresh." />
                <TestimonialCards rating={5} imagePath={person3} name="John Doe" review="Delicious and fresh." />
            </div>
        </section>
    );
};
